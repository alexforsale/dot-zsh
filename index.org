...
#+end_src
**** zoxide
[[https://github.com/ajeetdsouza/zoxide][zoxide]] is a smarter cd command, similar to =z= or =autojump=.
#+begin_src shell
...
**** 00-base.zsh
:PROPERTIES:
:header-args: :tangle .config/zsh/zshenv.d/00-base.zsh :mkdirp t
:END:
...
**** 10-cargo.zsh
:PROPERTIES:
:header-args: :tangle .config/zsh/zshenv.d/10-cargo.zsh :mkdirp t
:END:
...
:PROPERTIES:
:header-args: :tangle .config/zsh/zprofile.d/00-xdg-user-directories.zsh :mkdirp t
:END:
...
**** 90-python.zsh
:PROPERTIES:
:header-args: :tangle .config/zsh/zprofile.d/90-python.zsh :mkdirp t
:END:
